...
//     current_function_return_type: Option<Primitive>,
// }
//
// impl TypeChecker {
...
//                 }
//
//                 let block_type = if let Some(expr) = value { self.check_expr(expr)? } else { Primitive::Unit };
//
...
//
//                 let else_type = if let Some(else_expr) = else_branch { self.check_expr(else_expr)? } else { Primitive::Unit };
//
//                 if then_type != else_type {
//                     return Err(TypeError::TypeMismatch {
//                         expected: then_type.type_name(),
//                         found: else_type.type_name(),
//                         location: "if/else branches".to_string(),
//                     });
//                 }
//
//                 Ok(then_type)
...
//                     return Err(TypeError::TypeMismatch {
//                         expected: expected_return_type.type_name(),
//                         found: actual_type.type_name(),
...
//
//                 let outer_scope = self.variables.clone();
//                 let outer_return_type = self.current_function_return_type.clone();
//
//                 self.variables.clear();
